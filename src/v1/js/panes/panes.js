...
module.exports = function (params) {
	...
	Class.prototype.add = function (paneInstance) {
		...
		paneInstance.tab = $(`<div data-name="${paneInstance.name}" class="panes__tab"><a class="panes__tab_link" href="/?${paneInstance.name}${paneInstance.hrefParam ? '=' + paneInstance.hrefParam : ''}">${paneInstance.title}</a></div>`);
